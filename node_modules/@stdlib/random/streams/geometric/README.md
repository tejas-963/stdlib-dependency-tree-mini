...
> Create a [readable stream][readable-stream] for generating pseudorandom numbers drawn from a [geometric][geometric] distribution.
...
Returns a [readable stream][readable-stream] for generating pseudorandom numbers drawn from a [geometric][geometric] distribution with success probability `p`.
...
Returns a `function` for creating [readable streams][readable-stream] which generate pseudorandom numbers drawn from a [geometric][geometric] distribution.
...
```text
Usage: random-geometric [options] <p>
...
```bash
$ random-geometric 0.2 -n 10 --seed 1234
```
